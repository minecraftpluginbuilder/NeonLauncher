...
tasks.jar {
    ...
    destinationDirectory.set(file("../NeonLauncher/src/main/assets/components/lwjglVulkan/"))

    doLast {
        val versionFile = file("../NeonLauncher/src/main/assets/components/lwjglVulkan/version")
