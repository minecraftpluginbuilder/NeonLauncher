package com.neonlauncher.app.plugins.renderer
...
/**
 * Renderer plugin manager for NeonLauncher.
...
object RendererPluginManager {
    ...
    /**
     * Parses NeonLauncher renderer plugins from installed APKs.
     */
    fun parseApkPlugin(context: Context, info: ApplicationInfo) {
        ...
        val isRendererPlugin =
            metaData.getBoolean("fclPlugin", false) ||
                    metaData.getBoolean("neonRendererPlugin", false)
