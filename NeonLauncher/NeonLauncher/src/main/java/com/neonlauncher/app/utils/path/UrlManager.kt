package com.neonlauncher.app.utils.path
...
class UrlManager {
    companion object {
        ...
        const val URL_GITHUB_HOME: String =
            "https://api.github.com/repos/NeonLauncher/Neon-Info/contents/"

        // Your actual project page used by About screen
        const val URL_HOME: String =
            "https://github.com/DNAMobileApplications/NeonLauncherReborn"

        // Your GitHub Releases API used by the updater
        const val URL_GITHUB_RELEASES: String =
            "https://api.github.com/repos/DNAMobileApplications/NeonLauncherReborn/releases"
        ...
        const val URL_SUPPORT: String = "https://afdian.com/a/NeonLauncher Team"
