...
import com.neonlauncher.app.feature.version.utils.VersionInfoUtils
...
import com.neonlauncher.app.utils.stringutils.SortStrings
...
object VersionsManager {
    ...
    private fun processVersionFile(
        ...
        if (jsonFile.exists() && jsonFile.isFile) {
            ...
            val versionInfoFile = File(getNeonVersionPath(versionFile), "VersionInfo.json")
