...
val nameId = "com.neonlauncher.app"
val generatedNeonDir = file("$buildDir/generated/source/neon/java")
...
android {
    ...
    signingConfigs {
        create("releaseBuild") {
            ...
            storeFile = file("neonlauncher-key.jks")
            storePassword = pwd
            keyAlias = "mtp"
            keyPassword = pwd
        }
    ...
    sourceSets["main"].java.srcDirs(generatedNeonDir)
...
tasks.register("generateInfoDistributor") {
    doLast {
        ...
        generateJavaClass(generatedNeonDir, "com.neonlauncher.app", "InfoDistributor", constantMap)
    }
}
